...
export default function Navbar() {
  ...
  return (
    <nav 
      className="fixed top-4 md:top-8 left-1/2 -translate-x-1/2 w-[95%] md:w-[90%] max-w-6xl liquid-glass-nav rounded-full transition-all duration-300 ease-in-out translate-y-0 opacity-100 backdrop-blur-2xl bg-white/40 shadow-sm"
      style={{ zIndex: 9999 }}
    >
